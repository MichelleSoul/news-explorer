    ...
    return (
        <>
            <div className="
                    ...
                    md:-translate-y-16.5 md:pt-26 md:pb-12
                    lg:-translate-y-20 lg:pt-40 lg:pb-20
                ...
                <form className="relative md:w-113 lg:w-152"
                    ...
                    <Button type="submit" className="h-14 lg:h-16 mt-4 w-full md:mt-0 md:w-40 md:absolute md:right-0 md:top-0 lg:w-42" >Search</Button>
                </form>
            </div>
